...
function randomRange(min, max) {
  ...
  var assembleGeometry = function () {
    for (var i = 0; i < PARTICLE_COUNT; i++) {
      ...
      sprite.position.set(randomRange(-500, 500), randomRange(60, 500), randomRange(-500, 500));
...
// тени накапливался снег как работают перемножения матриц (rotateY) шейдеры в threejs какие есть какие бывают
// файлик obj посмотреть
// В каком порядке вызываются соыбтия MonoBehaviour в процессе рендеринга
